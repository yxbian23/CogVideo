...
export MODEL_PATH="/group/30098/yuxuanbian/hf_models/CogVideoX-2b"
export CACHE_PATH="~/.cache"
export DATASET_PATH="/group/30098/yuxuanbian/datasets/Disney-VideoGeneration-Dataset"
export OUTPUT_PATH="/group/30098/yuxuanbian/outputs/video_inpainting/cogvideox-2b-lora-multi-gpu"
