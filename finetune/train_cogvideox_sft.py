...
def main(args):
    ...
    # 获取transformer_blocks的总数
    num_blocks = len(transformer.transformer_blocks)
    num_freeze_blocks = 30

    # 只为前一半的transformer_blocks设置requires_grad=True
    for i, block in enumerate(transformer.transformer_blocks):
        if i > num_freeze_blocks - 1:
    ...
    # TODO: save and load the whole model
    ...
    train_dataset.instance_videos = [encode_video(video) for video in tqdm(train_dataset.instance_videos)]
